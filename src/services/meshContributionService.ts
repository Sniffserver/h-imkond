...
class MeshContributionService {
  ...
  public getLeaderboard(
    ...
    // Combine with peers
    const peerEntries: MeshLeaderboardNode[] = [];

    // Combine peers from props and initial presets
  ...
  private notifyListeners(): void {
    // Notify listeners with empty state so they re-pull
